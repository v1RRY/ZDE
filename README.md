...
**Akhtung! ZDE is not recommended to use in a real work. This is made just for fun!**

# Installing

For now there is no package in the repositories like AUR/DEB/DNF, but you can install ZDE manually. First, you should clone the repository:
